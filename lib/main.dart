...
import 'package:mybookly/Const/Color.dart';
...
import 'package:mybookly/views/Screen/SplashView.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context)=>MaterialCubit(mydata())..mydatafetch()),
...
debugShowCheckedModeBanner: false,      title: 'Flutter Demo',
          theme: ThemeData(
            ...
            scaffoldBackgroundColor: MyColor.main_color,
